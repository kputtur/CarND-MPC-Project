...
//DO: Set the timestep length and duration
size_t N = 10;
double dt = 0.05;
...
// Calculate starting indices for each of the 6 model variables and 2 actuator variables
size_t x_start = 0;
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // the Solver function below.
     fg [0] = 0;
      ...
      // reduce the gap between sequential actuations.
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  //setting the initial variable values here
  vars[x_start] = x;
  vars[y_start] = y;
  vars[psi_start] = psi;
  vars[v_start] = v;
  ...
  //set the values of steer and throttle  
